...
const OurBestProductsCard = ({ id, img, icon, title, discount_Price, price, Sale, addToCart,}) => {
  return (
    <>
      <div className="bg-white rounded-xl relative group">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="absolute top-40 hidden group-hover:block">
            <div className="flex flex-col gap-24 justify-center items-center">
              ...
              <div className="flex gap-4">
                ...
                <div onClick={() => addToCart(value)} className="bg-white hover:bg-primary p-3 rounded-full hover:text-white">
                  <FaShoppingCart />
                </div>
...
export default OurBestProductsCard;
